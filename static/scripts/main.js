...
function darkMode(){
    ...
    document.querySelector(".header__main--image img").src = '../static/assets/images/foreground-image-dark.png';
    // desktopThemeBtn
...
function lightMode(){
    ...
    //document.querySelector(".header__main--image img").src = '../static/assets/images/foreground-image-light.png'
    // desktopThemeBtn
